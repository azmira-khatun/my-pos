        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="reference" class="form-control" placeholder="REF-0001" value="{{ old('reference') }}">
                </div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="form-group">
            ...
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    <strong>Total Amount (Excluding Items):</strong>
            ...
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="payment_method" class="form-control" value="{{ old('payment_method') }}" placeholder="Cash, Bank, Cheque">
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="form-group">
                    <strong>Note:</strong>
                    <textarea class="form-control" style="height:100px" name="note" placeholder="Any special notes about this purchase">{{ old('note') }}</textarea>
                </div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-12 text-center mt-3">
                <button type="submit" class="btn btn-success">Save Purchase Info</button>
            </div>
        </div>
    </form>
</div>
